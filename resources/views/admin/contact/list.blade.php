...
@section('title','Contact query List | '.config('app.name'))
            ...
            <div class="content-header row">
                <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">Contact Query List</h2>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-left align-items-center">
                                                    {{-- <div class="avatar  me-1"><img src="{{ asset( ($contact?->image_id) ? $contact?->image_id : 'assets/images/no-preview.png' ) }}" alt="Avatar" width="32" height="32"></div> --}}
                                                    <div class="d-flex flex-column">
                                                        <span class="emp_name text-truncate fw-bold">{{ $contact?->name }}</span>
                                                        <small class="emp_post text-truncate text-muted">{{ $contact?->email }}</small>
                                                    </div>
                                                </div>
                                            </td>
