            ...
            <section id="basic-vertical-layouts">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <form class="form form-vertical" method="POST" action="{{ ($isEdit) ?  route('blog.update', $blog->id) : route('blog.store') }}" enctype="multipart/form-data" >
                                    @csrf
                                        ...
                                        <div class="col-md-6  col-12">
                                            <div class="mb-1">
                                                <div id="full-container">
                                                    <div class="editor" id="editor">@if ($isEdit) {!! $blog?->description !!} @endif</div>
                                                </div>
                                                {{-- <label class="form-label" for="description">Description</label> --}}
                                                {{-- <textarea class="form-control" name="description" id="" rows="8">{{ ($isEdit) ? $blog?->description : old('description')  }}</textarea> --}}
                                            ...
                                            <div class="mb-1">
                                                ...
                                                <div class="avatar-upload">
                                                    ...
                                                    <div class="avatar-preview">
                                                        <div id="imagePreview" style="background-image: url({{ asset( (isset($blog?->image)) ? $blog?->image : 'assets/images/no-preview.png' ) }});">
                                                        </div>
                                                    </div>
