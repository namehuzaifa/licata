...
<footer class="bi__footer">
        <div class="container text-center">
            <div class="pt-4">
                <img src="{{asset('front-assets/img/footer-logo.png')}}" class="img-fluid pb-5" />
                    ...
                    <div class="col-md-5 offset-md-1 mb-3">
                        <form>
                            ...
                            <div class="d-flex gap-3 followus">
                                <img src="{{asset('front-assets/img/fb.png')}}" />
                                <img src="{{asset('front-assets/img/twitter.png')}}" />
                                <img src="{{asset('front-assets/img/insta.png')}}" />
                            </div>
                        </form>
                    </div>
                </div>
